...
class Node<T extends Comparable<T>> {
    ...
    int height; // значение высоты поддерева с корнем в данном узле
    Node<T> left; // ссылка на левого потомка данного узла
    Node<T> right; // сслыка на правого потомка данного потомка

    // конструктор для создания экземпляра узла
    Node (T key) {
        this.key = key;
        height = 1;
    }
